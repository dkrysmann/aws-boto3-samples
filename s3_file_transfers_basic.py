...
local_file_path = 'myfile'
bucket_name = 'dms-dumps'
object_key = 'random_data_1g'
file_size_mb = 1073741824

tic = time.perf_counter()
print(upload_with_default_configuration(local_file_path, bucket_name, object_key, file_size_mb))
# print(upload_with_chunksize_and_meta(local_file_path, bucket_name, object_key, file_size_mb))
# print(upload_with_high_threshold(local_file_path, bucket_name, object_key, file_size_mb))
toc = time.perf_counter()
print(f"Downloaded the tutorial in {toc - tic:0.4f} seconds")

# upload_with_chunksize_and_meta(local_file_path, bucket_name, object_key, file_size_mb, metadata=None)